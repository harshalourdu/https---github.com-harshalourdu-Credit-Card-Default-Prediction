...
logging.basicConfig(filename='E:/CCDP/logfile.txt',level=logging.DEBUG,
...
app.layout = html.Div([
        ...
        dcc.Link(
            ...
            refresh=True,
            href='https://github.com/harshalourdu/https---github.com-harshalourdu-Credit-Card-Default-Prediction'),
